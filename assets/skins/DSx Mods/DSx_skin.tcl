...
add_de1_variable "$::DSx_standby_pages" 2140 736 -justify center -anchor "n" -font [DSx_font font 7] -fill $::DSx_settings(font_colour) -textvariable {[DSx_live_graph_data_timer]s   [DSx_live_graph_data_water]mL    $::DSx_settings(live_graph_weight)g}
add_de1_variable "espresso" 2140 736 -justify center -anchor "n" -font [DSx_font font 7] -fill $::DSx_settings(font_colour) -textvariable {[DSx_espresso_elapsed_timer]s   [DSx_water_data]mL  [round_to_one_digits $::de1(scale_sensor_weight)]g}
...
add_de1_variable "$::DSx_home_pages" 360 450 -justify right -anchor "nw" -font [DSx_font font 8] -fill $::DSx_settings(font_colour) -textvariable {Tank [round_to_one_digits [expr $::de1(water_level) / .65 - 7.7 ]]%}
...
add_de1_variable "$::DSx_home_pages" 200 1200 -text "" -font [DSx_font font 6] -fill $::DSx_settings(font_colour) -anchor "center" -justify "center" -width [rescale_x_skin 200] -textvariable {$::DSx_settings(blue_profile)}
add_de1_variable "$::DSx_home_pages" 420 1200 -text "" -font [DSx_font font 6] -fill $::DSx_settings(font_colour) -anchor "center" -justify "center" -width [rescale_x_skin 200] -textvariable {$::DSx_settings(pink_profile)}
add_de1_variable "$::DSx_home_pages" 640 1200 -text "" -font [DSx_font font 6] -fill $::DSx_settings(font_colour) -anchor "center" -justify "center" -width [rescale_x_skin 200] -textvariable {$::DSx_settings(orange_profile)}
...
add_de1_button "$::DSx_standby_pages" {say [translate {}] $::settings(sound_button_in); load_test; set_next_page off DSx_3_coffee; start_idle;}  360 320 700 540
...
add_de1_button "$::DSx_page_name" {page_show [DSx_page_right]} 2250 1250 2470 1500
add_de1_button "$::DSx_page_name" {page_show [DSx_page_left]} 1810 1250 2030 1500
...
add_de1_variable "DSx_4_workflow" 2200 230 -justify center -anchor center -font [DSx_font font 10] -fill $::DSx_settings(font_colour) -textvariable {(1:[round_to_one_digits [expr (0.01 + $::DSx_settings(saw))/$::settings(DSx_bean_weight)]])}
...
add_de1_variable "DSx_4_workflow" 1920 1200 -text "" -font [DSx_font font 6] -fill $::DSx_settings(font_colour) -anchor "center" -justify "center" -width [rescale_x_skin 200] -textvariable {$::DSx_settings(blue_profile)}
add_de1_variable "DSx_4_workflow" 2140 1200 -text "" -font [DSx_font font 6] -fill $::DSx_settings(font_colour) -anchor "center" -justify "center" -width [rescale_x_skin 200] -textvariable {$::DSx_settings(pink_profile)}
add_de1_variable "DSx_4_workflow" 2360 1200 -text "" -font [DSx_font font 6] -fill $::DSx_settings(font_colour) -anchor "center" -justify "center" -width [rescale_x_skin 200] -textvariable {$::DSx_settings(orange_profile)}
...
add_de1_button "DSx_4_workflow" {say [translate {DSx coffee}] $::settings(sound_button_in); page_show DSx_3_coffee;} 1000 340 1600 540
...
# data
add_de1_text "DSx_5_admin" 200 544 -text [translate {FW Version}] -font [DSx_font font 10] -fill $::DSx_settings(font_colour) -anchor "nw" -width [rescale_y_skin 1220] -justify "left"
add_de1_variable "DSx_5_admin" 200 634 -text "" -font [DSx_font font 8] -fill $::DSx_settings(font_colour) -anchor "nw" -width [rescale_y_skin 920] -justify "left" -textvariable {[de1_version_string]}
add_de1_text "DSx_5_admin" 200 220 -text [translate "Counter"] -font [DSx_font font 10] -fill $::DSx_settings(font_colour) -justify "left" -anchor "nw"
add_de1_text "DSx_5_admin" 200 310 -text [translate "Espresso"] -font [DSx_font font 8] -fill $::DSx_settings(font_colour) -anchor "nw"
add_de1_text "DSx_5_admin" 200 370 -text [translate "Steam"] -font [DSx_font font 8] -fill $::DSx_settings(font_colour) -anchor "nw"
add_de1_text "DSx_5_admin" 200 430 -text [translate "Hot water"] -font [DSx_font font 8] -fill $::DSx_settings(font_colour) -anchor "nw"
add_de1_variable "DSx_5_admin" 600 310 -text "" -font [DSx_font font 8] -fill $::DSx_settings(font_colour) -anchor "ne" -textvariable {[round_to_integer $::settings(espresso_count)]}
add_de1_variable "DSx_5_admin" 600 370 -text "" -font [DSx_font font 8] -fill $::DSx_settings(font_colour) -anchor "ne" -textvariable {[round_to_integer $::settings(steaming_count)]}
add_de1_variable "DSx_5_admin" 600 430 -text "" -font [DSx_font font 8] -fill $::DSx_settings(font_colour) -anchor "ne" -textvariable {[round_to_integer $::settings(water_count)]}
...
add_de1_variable "DSx_3_coffee" 1880 850 -text "" -font Helv_8 -fill #ccc -anchor "w" -justify left -textvariable {$::DSx_steps_output}
add_de1_variable "DSx_3_coffee" 2130 380 -justify center -anchor center -font [DSx_font font 10] -fill $::DSx_settings(font_colour) -textvariable {temperature}
add_de1_image "DSx_3_coffee" 1880 410 "[skin_directory_graphics]/icons/click1.png"
add_de1_variable "DSx_3_coffee" 2130 510 -justify center -anchor center -font [DSx_font font 10] -fill $::DSx_settings(font_colour) -textvariable {[DSx_temp_steps]}
...
proc back_to_previous_page {} {
    if {$::DSx_workflow_to_settings_1 == 1} {
            ...
            set_next_page off DSx_3_coffee; page_show DSx_3_coffee; set ::DSx_coffee_to_settings_1 0;
        } else {
...
add_de1_button "settings_1 settings_2 settings_2a settings_2b settings_2c settings_2czoom settings_2c2 settings_3 settings_4" {LRv2_preview; DSx_graph_restore; save_settings_to_de1; set_alarms_for_de1_wake_sleep; say [translate {save}] $::settings(sound_button_in); save_settings; profile_has_changed_set_colors;
    ...
    if {[array_item_difference ::settings ::settings_backup "enable_fahrenheit language skin waterlevel_indicator_on waterlevel_indicator_blink display_rate_espresso display_espresso_water_delta_number display_group_head_delta_number display_pressure_delta_line display_flow_delta_line display_weight_delta_line allow_unheated_water"] == 1 } {
        .can itemconfigure $::message_label -text [translate "Please quit and restart to load changes."] -fill $::DSx_settings(font_colour)
        set_next_page off message; page_show message; set ::DSx_workflow_to_settings_1 0; refresh_DSx_temperature;
    } else {
        back_to_previous_page;  DSx_graph_restore; clear_profile_font; off_cup; saw_switch; refresh_DSx_temperature;
    }
} 2016 1430 2560 1600
...
########################################################################################
### DSx profile rename - changes the numeric date type file name to the profile name ###
### To add this feature to other skins, edit the skins skin.tcl file, add to the end ###
########################################################################################
proc DSx_profile_rename {} {
    after cancel {set ::DSx_file_exists_message ""}
    ...
    set nfn "[homedir]/profiles/$::settings(profile_title).tcl"
    if {[string index $profile 0] > 9 || [string index $profile 0] < 0} {
        set ::DSx_file_exists_message "Please check your selection,\rsomething doesn't look like right!"
        after 4000 {set ::DSx_file_exists_message ""}
        return;
    }
    if {[catch {file rename $fn $nfn} err] != 0} {
        set ::DSx_file_exists_message "Please tap the profile and try again"
        after 4000 {set ::DSx_file_exists_message ""}
        return;
    }
    set ::DSx_file_exists_message "Done!"
    after 4000 {set ::DSx_file_exists_message ""}
    set ::settings(profile) "$::settings(profile_title)"
	fill_profiles_listbox
}
add_de1_variable "settings_1" 1120 1250 -text "" -font Helv_8 -fill #ccc -anchor "w" -justify center -textvariable {DSx file\rRename}
add_de1_button "settings_1" {say [translate {save}] $::settings(sound_button_in); borg toast [translate "Profile Renamed by DSx"]; DSx_profile_rename} 1120 1160 1280 1320
add_de1_variable "settings_1" 700 1340 -text "" -font Helv_8 -fill #ff574a -anchor center -justify center -textvariable {$::DSx_file_exists_message}
########################################################################################

#add_de1_button "$::DSx_standby_pages" {say "" $::settings(sound_button_in); load_DSx_coffee; DSx_set_on; after 1200 DSx_set_off;} 530 1250 750 1500
#add_de1_button "$::DSx_standby_pages" {say [translate {}] $::settings(sound_button_in); show_settings; after 500 update_de1_explanation_chart; say [translate {settings}] $::settings(sound_button_in); set_next_page off settings_1; page_show off; set ::settings(active_settings_tab) settings_1; set_profiles_scrollbar_dimensions; DSx_coffee_settings_2c;}  100 550 700 720
